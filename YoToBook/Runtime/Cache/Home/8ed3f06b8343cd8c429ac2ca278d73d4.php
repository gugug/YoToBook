...
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>登录</div>
            <div class="feat_prod_box_details">
                <div class="contact_form">
                    <div class="form_subtitle">login into your account</div>
                    <form name="login" method='post' action="<?php echo U('Users/dologin');?>">
                        <div class="form_row">
                        ...
                        <div class="form_row">
                            <input type="text" class="input input-big" name="code" placeholder="填写右面的验证码" data-validate="required:请填写右侧的验证码" />
                            <img src="<?php echo U('Users/verify',array());?>" id='verify_img' onclick="this.src='<?php echo U('Users/verify',array());?>'"/>						
                        ...
                        <div class="form_row">
                            <div class="right_button"><input type="submit" id='return' class="btn btn-info" value="登录" /></div>
                        </div>
                    </form>
