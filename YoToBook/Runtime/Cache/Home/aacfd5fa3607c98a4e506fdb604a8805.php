...
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            <div class="crumb_nav"> <a href="<?php echo U('Index/index');?>">home</a> &gt;&gt; 书类别 </div>
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>各种类型的书</div>
            <div class="new_products">
                ...
                <?php if(is_array($typeResult)): $i = 0; $__LIST__ = $typeResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><div class="crumb_nav"> <a href="/YoToBook/Books/specialType/<?php echo ($vo['type']); ?>"><?php echo ($vo['type']); ?></a><br />
                            <!--<div class="new_prod_bg"> <span class="new_icon"><img src="/YoToBook/Public/images/promo_icon.gif" alt="" title="" /></span> <a href="<?php echo U('Books/details');?>"><img src="/YoToBook/Public/images/thumb2.gif" alt="" title="" class="thumb" border="0" /></a> </div>-->
