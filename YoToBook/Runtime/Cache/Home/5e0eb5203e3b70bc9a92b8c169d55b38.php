...
<title>Book Store</title>
<link rel="stylesheet" type="text/css" href="/YoToBook/Public/css/style.css" />
<link rel="stylesheet" href="/YoToBook/Public/css/lightbox.css" type="text/css" media="screen" />
<script src="/YoToBook/Public/js/prototype.js" type="text/javascript"></script>
<script src="/YoToBook/Public/js/scriptaculous.js?load=effects" type="text/javascript"></script>
<script src="/YoToBook/Public/js/lightbox.js" type="text/javascript"></script>
<script type="text/javascript" src="/YoToBook/Public/js/java.js"></script>
</head>
<!--图书详情-->
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            <div class="crumb_nav"> <a href="<?php echo U('Index/index');?>">首页</a> &gt;&gt;  </div>
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>书名: <?php echo ($bookdetails['b_name']); ?></div>
            <div class="feat_prod_box_details">
                <div class="prod_img"><img src="/YoToBook/Public/<?php echo ($bookdetails['b_pic_src']); ?>" alt="" title="" border="0" /><br />
                    <br />
                    <a href="/YoToBook/Public/<?php echo ($bookdetails['b_pic_src']); ?>" rel="lightbox"><img src="/YoToBook/Public/images/zoom.gif" alt="" title="" border="0" /></a> </div>
                <div class="prod_det_box">
                    <div class="box_top"></div>
                    <div class="box_center">
                        <div class="prod_title">*****详情*****</div>
                        <p class="details"><strong>书的简介：</strong> <span class="red"><?php echo ($bookdetails['introduction']); ?><br />
                                <p class="details"><strong>书的类别：</strong> <span class="red"><?php echo ($bookdetails['type']); ?><br />
                                        <p class="details"><strong>书的出版社：</strong> <span class="red"><?php echo ($bookdetails['press']); ?><br />
                                                <div class="price"><strong>价格：</strong> <span class="red">￥<?php echo ($bookdetails['price']); ?> </span></div>
                                                <a href="/YoToBook/Users/order_now/<?php echo ($bookdetails['b_id']); ?>" class="more"><img src="/YoToBook/Public/images/order_now.gif" alt="" title="" border="0" /></a>
                                                <div class="clear"></div>
                                                </div>
                                                ...
                                                <div id="demo" class="demolayout">
                                                    <ul id="demo-nav" class="demolayout">
                                                        <li><a class="active" href="#tab1">更多详细</a></li>
                                                        <li><a class="" href="#tab2">相关书籍(<?php echo (count($releateBooks)); ?>)</a></li>
                                                    </ul>
                                                    <div class="tabs-container">
                                                        <div style="display: block;" class="tab" id="tab1">
                                                            <p class="more_details">书的详细介绍 </p>
                                                            <ul class="list">
                                                                <li><a href="/YoToBook/Books/comments/<?php echo ($detailsid); ?>">书评(<?php echo (count($commentsNum)); ?>)</a></li>
                                                            </ul>
                                                        </div>
                                                        
                                                        <div style="display: none;" class="tab" id="tab2">
                                                            <?php if(is_array($releateBooks)): $i = 0; $__LIST__ = $releateBooks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="new_prod_box"> <a href="/YoToBook/Books/details/<?php echo ($vo['b_id']); ?>"><?php echo ($vo['b_name']); ?></a>
                                                                    <div class="new_prod_bg"> <a href="/YoToBook/Books/details/<?php echo ($vo['b_id']); ?>">
                                                                        <img src="/YoToBook/Public/<?php echo ($vo['b_pic_src']); ?>" alt="" title="" class="thumb" border="0" /></a> 
                                                                    </div>
