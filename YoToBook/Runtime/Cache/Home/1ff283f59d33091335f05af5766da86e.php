...
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            ...
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>搜索结果 数量： <?php echo (count($searchResult)); ?></div>


            <?php if(is_array($searchResult)): $i = 0; $__LIST__ = $searchResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="feat_prod_box">
                    <div class="prod_img"><a href="/YoToBook/Books/details/<?php echo ($vo['b_id']); ?>"><img src="/YoToBook/Public/<?php echo ($vo['b_pic_src']); ?>" alt="" title="" border="0" /></a></div>
                    <div class="prod_det_box"> <span class="special_icon"><img src="/YoToBook/Public/images/special_icon.gif" alt="" title="" /></span>
                        <div class="box_top"></div>
                        <div class="box_center">
                            <div class="prod_title">书名 <?php echo ($vo['b_name']); ?></div>
                            <p class="details">书的简介 <?php echo ($vo['introduction']); ?></p>
                            <a href="details/<?php echo ($vo['b_id']); ?>" class="more">- 更多 -</a>
                            <div class="clear"></div>
                        </div>
