...
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            <div class="crumb_nav"> <a href="<?php echo U('Books/category');?>">书类别</a> &gt;&gt;  </div>
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title=""/></span><?php echo ($specialTypeResult[0]['type']); ?>&gt;&gt;数量：<?php echo (count($specialTypeResult)); ?></div>
            <div class="new_products">

                <?php if(is_array($specialTypeResult)): $i = 0; $__LIST__ = $specialTypeResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="new_prod_box"> <a href="/YoToBook/Books/details/<?php echo ($vo['b_id']); ?>"><?php echo ($vo["b_name"]); ?></a>
                        <div class="new_prod_bg"> <a href="/YoToBook/Books/details/<?php echo ($vo['b_id']); ?>"><img src="/YoToBook/Public/<?php echo ($vo['b_pic_src']); ?>" alt="" title="" class="thumb" border="0" width="50%"/></a> </div>
