        ...
        <div class="center_content">
            <div class="left_content">
                <div class="index_sub_left_content">
                    <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>书评</div>
                    <div class="feat_prod_box">
                        <!--        <div class="prod_img"></div>-->
                        <div class="title">这是书的评论 数量： <?php echo (count($commentRresult)); ?></div>

                        <?php if(is_array($commentRresult)): $i = 0; $__LIST__ = $commentRresult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="feat_prod_box">
                                <div class="prod_det_box">
                                    <div class="box_top"></div>
                                    <div class="box_center">
                                        <div class="prod_title">
                                            用户名：<?php if(($vo["anonymity"]) == "on"): ?>匿名<?php else: echo ($vo['user_account']); endif; ?><br><br>
                                            评论：<?php echo ($vo['comment_content']); ?><br><br>
                                            评论时间：<?php echo (date("Y-m-d H:i",$vo['comment_time'])); ?>
                                            <div class="delete_button"><?php if(($vo["user_account"]) == $_SESSION['username']): ?><a href="/YoToBook/Books/deletecomment/<?php echo ($vo['comment_bid']); ?>/<?php echo ($vo['comment_id']); ?>"><input type="button" id='return' class="btn btn-info" value="删除"></a><?php else: endif; ?></div>
                                        </div>
                                        </br>
                    ...
                    <div class="delete_button">
                        <a href="/YoToBook/Books/addComment/<?php echo ($bookid); ?>"><button id='return' class="btn btn-info">我也来发表评论</button></a>
                        <a href="/YoToBook/Books/details/<?php echo ($bookid); ?>"><button id='return' class="btn btn-info">返回详情</button></a>
                    </div>
                </div>
            </div>
    </body>
