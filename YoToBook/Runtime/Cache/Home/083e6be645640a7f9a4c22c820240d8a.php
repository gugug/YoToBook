...
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>联系我们</div>
            <div class="feat_prod_box_details">
                <div class="contact_form">
                    <div class="form_subtitle">all fields are requierd</div>
                    <form name="contact_us" method='post' action="<?php echo U('Users/do_contact_us');?>"> 
                        <div class="form_row">
                        ...
                        <div class="form_row"> 
                            <div class="right_button"><input type="submit" id='return' class="btn btn-info" value="确认" /></div>
                        </div>
                    </form>
