...
<div class="center_content">
    <div class="left_content">
        <div class="index_sub_left_content">
            <div class="title"><span class="title_icon"><img src="/YoToBook/Public/images/bullet1.gif" alt="" title="" /></span>我的订单</div>
            <div class="feat_prod_box_details">
                <div class="contact_form">
                    <div class="form_subtitle">我的订单</div>
                    <form name="register" method='post' action="<?php echo U('Users/doorder');?>">
                        <div class="form_row">
                        ...
                        <div class="form_row">
                            <label class="contact"><strong>送货地址：</strong></label>
                            <input type="text" name='address' class="contact_input" />
                        </div>
                        <div class="form_row">
                            <label class="contact"><strong>购买清单：</strong></label><br><br>
                            <table class="cart_table">
                                ...
                                <?php if(is_array($blist)): $i = 0; $__LIST__ = $blist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="ss">
                                        ...
                                        <td><?php echo ($order_result[$i-1]["s_num"]); ?></td>
                                        <td>￥<?php echo ($pricelist[$i-1]); ?></td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                <tr class="cart_title">
                                    <td colspan="4"></td>
                                    <td>总价：<?php echo ($totalMoney); ?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="form_row">
                            <div class="left_button"><a href=<?php echo U('Users/cart');?>><input type="button" id='return' class="btn btn-info" value="返回购物车" /></a></div>
                            <div class="right_button"><input type="submit" id='return' class="btn btn-info" value="提交订单" /></div>
                        </div>
                    </form>
                </div>
            </div>
